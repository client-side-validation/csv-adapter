...
impl TrustPackage {
    ...
    fn signing_message(&self) -> Vec<u8> {
        ...
        msg.extend_from_slice(self.chain_id.0.as_bytes());
        msg.extend_from_slice(self.trusted_checkpoint.as_ref());
        msg.extend_from_slice(&self.checkpoint_height.to_le_bytes());
        msg.extend_from_slice(&self.generation_epoch.to_le_bytes());
        msg.extend_from_slice(&self.validator_commitment.len().to_le_bytes());
        msg.extend_from_slice(&self.validator_commitment);
        msg
    }
